                    ...
                    <div className="mt-2 w-full px-4 py-2 rounded-r-lg text-white">
                      <p className="line-clamp-1">
                        <ol className="mt-1 text-white/50 font-medium text-base ml-10 mb-5 list-disc">
                          <li>
                            <a className="text-amber-500 hover:text-amber-800" href="#best_practice">{ $.bot_rules.navigation.bp }</a>
                          </li>
                        </ol>
                      </p>
                    </div>
                  ...
                  <div className="flex items-center shadow-xl">
                    <div className="mt-2 w-full px-4 py-2 rounded-r-lg text-white">
                      <p className="line-clamp-1">
                        <ol className="mt-1 text-white/50 font-medium text-base ml-10 mb-5 list-disc">
                          <li>
                            <a className="text-amber-500 hover:text-amber-800" href="#basic_rules">{ $.bot_rules.navigation.br }</a>
                          </li>
                        </ol>
                      </p>
                    </div>
                  ...
                  <div className="flex items-center shadow-xl">
                    <div className="mt-2 w-full px-4 py-2 rounded-r-lg text-white">
                      <p className="line-clamp-1">
                        <ol className="mt-1 text-white/50 font-medium text-base ml-10 mb-5 list-disc">
                          <li>
                            <a className="text-amber-500 hover:text-amber-800" href="#command_rules">{ $.bot_rules.navigation.cr }</a>
                          </li>
                        </ol>
                      </p>
                    </div>
                  ...
                  <div className="flex items-center shadow-xl">
                    <div className="mt-2 w-full px-4 py-2 rounded-r-lg text-white">
                      <p className="line-clamp-1">
                        <ol className="mt-1 text-white/50 font-medium text-base ml-10 mb-5 list-disc">
                          <li>
                            <a className="text-amber-500 hover:text-amber-800" href="#user_safety">{ $.bot_rules.navigation.us }</a>
                          </li>
                        </ol>
                      </p>
                    </div>
                  ...
                  <div className="flex items-center shadow-xl">
                    <div className="mt-2 w-full px-4 py-2 rounded-r-lg text-white">
                      <p className="line-clamp-1">
                        <ol className="mt-1 text-white/50 font-medium text-base ml-10 mb-5 list-disc">
                          <li>
                            <a className="text-amber-500 hover:text-amber-800" href="#common_etiquette">{ $.bot_rules.navigation.ceq }</a>
                          </li>
                        </ol>
                      </p>
                    </div>
              ...
              <div className="text-left w-auto h-auto bg-gradient-to-br from-neutral-900/90 to-neutral-900/50 rounded-lg p-6 shadow-md mx-auto" id="widgets">
                <div className="px-4 mx-auto w-auto sm:px-6 lg:px-8">
                    <div className="col-span-9 pt-5 lg:pt-0 w-auto">
                      ...
                      <p className="text-sm text-white/30 mb-1">{ $.bot_rules.updated }</p>

                      <h2 className="mt-10 text-white font-bold text-3xl" id="best_practice">
                      ...
                      <h2 className="mt-10 text-white font-bold text-3xl" id="basic_rules">
                      ...
                      <h2 className="mt-10 text-white font-bold text-3xl" id="command_rules">
                      ...
                      <h2 className="mt-10 text-white font-bold text-3xl" id="user_safety">
                        <span className="text-amber-500">3.</span>
                        {" "} 
                      ...
                      <h2 className="mt-10 text-white font-bold text-3xl" id="common_etiquette">
                        <span className="text-amber-500">3.</span>
                        {" "} 
