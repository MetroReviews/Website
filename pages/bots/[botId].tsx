               ...
               <div className="items-center justify-center">
                  <div className="flex items-center shadow-xl">
                    ...
                    <div className="mt-2 bg-amber-600 w-full px-4 py-2 rounded-r-lg text-white">
                      <p className="line-clamp-1">
                          {
                            bot.state === 0 ? 'Pending Review' :
                            bot.state === 1 ? 'Under Review' :
                  ...
                  <div className="flex items-center shadow-xl">
                    ...
                    <div className="mt-2 bg-amber-600 w-full px-4 py-2 rounded-r-lg text-white">
                       <p className="line-clamp-1">
                           {
                              bot.cross_add === true ? 'Cross Add Supported' :
                              bot.cross_add === false ? 'Not Cross Add Supported' :
                              'Unknown'
                           }
                       </p>
                    </div>
              ...
              <div className="mt-5">
               ...
               <div className="items-center justify-center">
                  <div className="flex items-center shadow-xl">
                    ...
                    <div className="mt-2 bg-amber-600 w-full px-4 py-2 rounded-r-lg text-white">
                      <p className="line-clamp-1">{bot.prefix ? bot.prefix : 'Slash Commands'}</p>
                    </div>
                  </div>
                  <div className="flex items-center shadow-xl">
                    <div className="mt-2 bg-amber-800 text-center px-4 py-2 rounded-l-lg text-white">
                  ...
                  <div className="flex items-center shadow-xl">
                    ...
                    <div className="mt-2 bg-amber-600 w-full px-4 py-2 rounded-r-lg text-white">
                       <p className="line-clamp-1">{new Date(bot.added_at).toLocaleString()}</p>
                    </div>
                </div>
                <div className="flex items-center shadow-xl">
                    <div className="mt-2 bg-amber-800 text-center px-4 py-2 rounded-l-lg text-white">
            ...
            <div className="mt-5">
              <div className="text-center w-full h-auto bg-gradient-to-br from-neutral-900/90 to-neutral-900/50 rounded-lg p-6 shadow-md mx-auto" id="widgets">
                <div className="px-4 mx-auto w-auto sm:px-6 lg:px-8 lg:text-center break-all">
                    <div className="markdown-body col-span-9 pt-5 lg:pt-0 w-auto break-all" dangerouslySetInnerHTML={{ __html: long }} />
                </div>
              </div>
            </div>
          </div>
